...
class SearchActivity : AppCompatActivity() {
    ...
    private val trackHistoryAdapter =
        TrackAdapter(searchHistoryInteractor.getTrackHistory(), onClick)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val searchTextWatcher = object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                searchDebounce()
                if (binding.inputSearch.hasFocus() && s?.isEmpty() == true && searchHistoryInteractor.getTrackHistory()
                        .isNotEmpty()
                ) {
        ...
        binding.inputSearch.setOnFocusChangeListener { _, hasFocus ->
            if (hasFocus && binding.inputSearch.text.isEmpty() && searchHistoryInteractor.getTrackHistory()
                    .isNotEmpty()
            ) {
                binding.historyLayout.isVisible = true
                binding.errorPlaceholder.isVisible = false
